...
Το TrojanCallBlocker αποθηκεύει τους αποκλεισμένους αριθμούς σε μια τοπική βάση δεδομένων. Καμία πληροφορία δεν μεταδίδεται σε κανένα σημείο του Διαδικτύου. Δεν υπάρχει παρακολούθηση και δεν υπάρχουν διαφημίσεις.
