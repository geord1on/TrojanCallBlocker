...
Εμπνευσμένο απο την αρχαία Τροία με τον Δούρειο Ίππο να γίνεται το λογότυπο της εφαρμογής αποτρέποντας να μην έρθουν σε επαφή με τους χρήστες οποιοδήποτε τηλεφώνημα (σπαμ,κακόβουλο),έχοντας το κεφάλι τους ήσυχο.
